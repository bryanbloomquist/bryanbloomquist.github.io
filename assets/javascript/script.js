...
let portfolio = () => {
  ...
  $( "#content" ).html( `
    <div class = "row justify-content-center">
      <div class = "col-12 col-lg-10 header animated slideInDown slow">
        <h2 class = "engraved pt-2">Portfolio</h2>
      </div>
    </div>
    <div class = "row justify-content-center">
      <div class = "col-12 col-lg-10 portfolio p-3 animated slideInLeft slow">
        <div class = "row justify-content-center">
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-1000ms">
          ...
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-1250ms">
            <div class = "hovereffect m-1">
          ...
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-1500ms">
            <div class = "hovereffect m-1">
          ...
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-1750ms">
            <div class = "hovereffect m-1">
          ...
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-2000ms">
            <div class = "hovereffect m-1">
          ...
          <div class = "col-12 col-md-6 col-xl-4 p-2 float-left animated flipInX delay-2250ms">
            <div class = "hovereffect m-1">
...
let techSkills = () => {
  ...
  $( "#content" ).html( `
    <div class = "row justify-content-center">
      <div class = "col-12 col-lg-8 header animated slideInDown slow">
        <h2 class = "engraved pt-2">Technical Skills</h2>
      </div>
    </div>
    <div class = "row justify-content-center">
      <div class = "col-12 col-lg-8 techskills animated slideInLeft slow">
        <div class = "row justify-content-center">
...
let aboutMe = () => {
  ...
  $( "#content" ).html( `
    ...
    <div class = "row justify-content-center">
      <div class = "col-12 col-lg-8 aboutme p-3 animated slideInLeft slow">
    ...
    <div class = "row justify-content-center">
      <div class = "col-12 col-sm-5 col-lg-4 header contactinfo engraved p-3 animated slideInUp slow">
        <h5>Phone: <a href = "tel:1-612-226-8339">(612) 226 - 8339</a></h5>
      </div>
      <div class = "col-12 col-sm-7 col-lg-4 header contactinfo engraved p-3 animated slideInUp slow">
...
let allApps = () => {
  ...
  $( "#content" ).html( `
    <div class = "row justify-content-center">
      <div class = "col-12 col-md-10 header animated slideInDown slow">
        <h2 class = "engraved pt-2">Full Project List</h2>
      </div>
    </div>
    <div class = "row justify-content-center">
      <div class = "col-6 col-md-5 allapps p-3 animated slideInLeft slow">
      ...
      <div class = "col-6 col-md-5 allapps p-3 animated slideInRight slow">
