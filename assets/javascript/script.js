  ...
  $( "#content" ).html( `
    ...
    <div class = "row justify-content-center">
      <div class = "col-xs-12 col-lg-8 aboutme p-3">
        <img class = "float-right biopic p-3 animated fadeInRightBig delay-2000ms" src = "assets/images/bio-pic.png" alt = "profile picture">
        <p class = "animated fadeInLeftBig delay-1000ms">
        ...
        <p class = "animated fadeInLeftBig delay-1250ms">
        ...
        <p class = "animated fadeInLeftBig delay-1500ms">
    ...
    <div class = "row justify-content-center">
      <div class = "col-xs-12 col-sm-5 col-md-3 header contactinfo engraved p-3 animated fadeInLeftBig delay-2500ms">
        <h5>Phone: <a href = "tel:1-612-226-8339">(612) 226 - 8339</a></h5>
      </div>
      <div class = "col-xs-12 col-sm-7 col-md-5 header contactinfo engraved p-3 animated fadeInRightBig delay-2500ms">
